...
### Operations Summary: Florida, California
...
#### Florida Strawberry Production 2019 - 2023

```{r}
#| label: florida survey_totals tables
#| echo: false
...
Units <- c("$-cwt", "ac", "ac", "$(000)", "(000)cwt", "cwt-ac", "cwt", "(000)cwt")
...
fl_19_23 <- fl_19_23 |> num_in_000_trunc(4,2)

fl_19_23 <- fl_19_23 |> num_in_000_trunc(5,2)

fl_19_23 <- fl_19_23 |> num_in_000_trunc(8,2)

fl_19_23 |> kbl()

```

#### California Strawberry Production 2019 - 2023

```{r}
#| label: California survey_totals tables
#| echo: false


CA_19_23 <- as.data.frame(sur_CA_19_23)

colnames(CA_19_23) <- c("Measure", "Units", "2019", "2020", "2021", "2022", "2023")

CA_19_23$Measure <- c("Price", "Havested", "Planted", "Production", "Production", "Yield", "Not Sold", "Utilized")

CA_19_23 <- CA_19_23 |> select(-Units)

Units <- c("$-cwt", "ac", "ac", "$(000)", "(000)cwt", "cwt-ac", "cwt", "(000)cwt")

CA_19_23 <- CA_19_23 |> mutate(Units, .after=Measure)

CA_19_23 <- CA_19_23 |> num_in_000_trunc(4,2)

CA_19_23 <- CA_19_23 |> num_in_000_trunc(5,2)

CA_19_23 <- CA_19_23 |> num_in_000_trunc(8,2)

CA_19_23 |> kbl()


## clean up env -- we are finished with "sur_" objects
## 

rm(list=ls(pattern="^sur_"))
rm("Units")
